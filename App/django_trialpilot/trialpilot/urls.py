...
from .views import clinical_trial_upload, criteria_conversion, diary_list, manual_matching, parameter_extraction, document_upload, patient_list, index, diary_remove, diary_details, patient_reset, trial_list, trial_details, trial_remove, criteria_extraction, dev_tools, match_patients
...
urlpatterns = [
    ...
    path('trials/upload/', clinical_trial_upload, name='clinical_trial_upload'),
    path('trials/<int:trial_id>/<int:patient_id>/<int:criterion_id>/', manual_matching, name='manual_matching'),
