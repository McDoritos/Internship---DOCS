...
class DocumentModelTest(TestCase):
    ...
    def test_create_clinical_diary_document(self):
        ...
        self.assertEqual(document.title, "Patient diary 001")
        self.assertEqual(document.type, "diary")
        self.assertFalse(document.extracted)
    ...
    def test_document_string_representation(self):
        ...
        self.assertEqual(str(document), "Trial ABC - trial")
...
class ClinicalTrialModelTest(TestCase):
    ...
    def test_create_clinical_trial(self):
        ...
        trial = ClinicalTrial.objects.create(
            ...
            pathology_group=ClinicalTrial.PathologyGroupType.PNEUMOLOGIA,
            status=ClinicalTrial.TrialStatus.RECRUITING
        )

        self.assertEqual(trial.study_name, "Lung Cancer Trial")
    ...
    def test_trial_str(self):
        ...
        self.assertEqual(str(trial), "Trial X")
...
class VersionModelTest(TestCase):
    ...
    def test_document_can_have_versions(self):
        ...
        self.assertEqual(str(version), "Diary - v1")
...
class PatientProfileModelTest(TestCase):
    ...
    def test_patient_str(self):
        ...
        self.assertEqual(str(patient), f"Patient {patient.id} - Breast Cancer")
...
class TreatmentModelTest(TestCase):
    ...
    def test_patient_treatment_relation(self):
        ...
        self.assertEqual(patient.treatments.count(), 1)
        self.assertIn("Chemotherapy", str(treatment))
...
class TrialCohortModelTest(TestCase):
    ...
    def test_create_cohort(self):
        ...
        self.assertEqual(trial.cohorts.count(), 1)
        self.assertEqual(str(cohort), "Study A - Advanced patients")
...
class TrialCriteriaModelTest(TestCase):
    ...
    def test_create_trial_criterion(self):
        ...
        trial = ClinicalTrial.objects.create(
            document=document,
            study_name="Study Criteria",
            pathology_group="mama",
            status="recruiting"
        )

        # CORREÇÃO: Usar clinical_trial em vez de document
        ...
        self.assertFalse(criterion.validated)
        self.assertEqual(criterion.type, "inclusion")
...
class LogicCriteriaModelTest(TestCase):
    ...
    def test_logic_is_connected_to_criterion(self):
        ...
        self.assertEqual(criterion.logic, logic)
...
class PatientTrialMatchTest(TestCase):
    ...
    def test_duplicate_match_is_not_allowed(self):
        ...
        trial_instance = ClinicalTrial.objects.create(
            document=trial_doc,
            study_name="Study Match",
            pathology_group="mama",
            status="recruiting"
        )
...
class CriterionEvaluationTest(TestCase):
    ...
    def test_unique_evaluation_per_match_and_criterion(self):
        ...
        patient_doc = Document.objects.create(
            title="Diary Patient",
            type=Document.DocumentType.CLINICAL_DIARY
        )

        patient = Patient_profile.objects.create(
            document=patient_doc,
            age=55,
        ...
        self.assertEqual(evaluation.automatic_result, "pass")
